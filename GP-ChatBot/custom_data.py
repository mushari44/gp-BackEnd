# custom_data.py
# الاعتماد الاكاديمي لكلية علوم الحاسب لجامعة الامام
custom_data = """
    ...
    - Curriculum Structure:
        ...
        - Key Courses and Topics:
            - computer Science plan:
                - The Bachelor of Computer Science program at Imam Mohammad Ibn Saud Islamic University (IMSIU) spans eight semesters:
                - totaling 136 credit hours. The curriculum is structured as follows:
